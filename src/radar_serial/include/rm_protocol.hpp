#ifndef RM_PROTOCOL_HPP
#define RM_PROTOCOL_HPP
...
constexpr uint16_t CMD_ID_INTERACTION   = 0x0301; 
constexpr uint16_t CMD_ID_RADAR_MAP     = 0x0305; 
constexpr uint16_t CMD_ID_RADAR_INFO    = 0x020E; 

// =========================================================================
// 0x0305 小地图坐标 (V1.3.0 标准 48 Bytes)
// =========================================================================
...
struct __attribute__((packed)) radar_double_damage_packet_t {
...
inline uint8_t Get_CRC8_Check_Sum(const uint8_t *pchMessage, uint32_t dwLength, uint8_t ucCRC8) {
    uint8_t ucIndex;
    while (dwLength--) {
...
inline bool Verify_CRC8_Check_Sum(const uint8_t *pchMessage, uint32_t dwLength) {
...
inline void Append_CRC8_Check_Sum(uint8_t *pchMessage, uint32_t dwLength) {
    uint8_t ucCRC = 0;
...
inline bool Verify_CRC16_Check_Sum(const uint8_t *pchMessage, uint32_t dwLength) {
